...
**Data Source:** [Gill and Tompkins 2020](http://cvpia-habitat-docs-markdown.s3-website-us-west-2.amazonaws.com/watershed/Regional_Approximation.html){target="_blank"}
```{r, include=FALSE}
...
**Data Source:** [Hackenjos 2019](https://cvpiahabitat-r-package.s3.us-west-2.amazonaws.com/cvpia-sit-model-inputs/DeerCreek_2Dmodel_FlowWest_Final.pdf){target="_blank"}. For additional information see [Gill and Tompkins 2021](http://cvpia-habitat-docs-markdown.s3-website-us-west-2.amazonaws.com/watershed/deer_creek.html){target="_blank"}.
...
*...with `r nrow(antelope_creek_floodplain) - 5` more rows*
